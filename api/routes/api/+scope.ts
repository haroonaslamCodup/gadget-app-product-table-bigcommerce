...
/**
 * API Route Scope Plugin
 *
 * This file configures CORS settings for all routes in the api/routes/api directory.
 * These routes are publicly accessible from the BigCommerce storefront widget.
...
export default async function (server: Server) {
  // Configure CORS for all API routes in this scope
  server.setScopeCORS({
